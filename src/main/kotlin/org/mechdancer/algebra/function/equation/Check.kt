 ...
 * 即 系数矩阵行数 等于 常数向量维数
 */
fun AugmentedMatrix.isAvailable() =
 ...
 * 判断方程组是否欠定
 */
fun AugmentedMatrix.isUnderdetermined() =
 ...
 * 判断方程组是否适定
 */
fun AugmentedMatrix.isWellPosed() =
	args.isSquare()
 ...
 * 判断方程组是否超定
 */
fun AugmentedMatrix.isOverdetermined() =
	args.row > args.column
